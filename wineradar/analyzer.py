...
_korean_analyzer: KoreanAnalyzer | None = KoreanAnalyzer()
...
def _matches_non_ascii_keyword(text: str, text_lower: str, keyword: str) -> bool:
    if _korean_analyzer is not None and getattr(_korean_analyzer, "_kiwi", None) is not None:
        return _korean_analyzer.match_keyword(text, keyword)
